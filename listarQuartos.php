...
<body>
	...
	<h2 align="center">-Listar Quarto-</h2>
	<div align="center">
	...
	<div class="container-fluid">
        ...
        ?>
				...
				$sql = "
				SELECT *
				FROM Quarto INNER JOIN categoriaquarto ON idCategoria = categoriaQuarto_idCategoria 
				";
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						?>
						<tr>
							<th scope="row"><?php echo $infoUsuario->numeroQuarto; ?></th>
							<td><?php echo $infoUsuario->nomeCategoria; ?></td>
							<td>
								<a href="alterarQuarto.php?id=<?php echo $infoUsuario->numeroQuarto; ?>">
								<i class="far fa-edit text-warning fa-lg"></i>
								</a>                   
								<a href="excluirQuarto.php?id=<?php echo $infoUsuario->numeroQuarto; ?>">
