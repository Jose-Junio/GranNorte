    ...
    <div class="container-fluid">
      <div class="row">
        ...
        ?>
			...
			<form action="inserirCategoriaBanco.php" method="post">
				...
				<select name="img" class="form-control">
					<?php
						while($infoCat = mysqli_fetch_object($resultado)){
							?>
							<option value="<?php echo $infoCat->idImagem;?>"><?php echo $infoCat->descricao; ?></option>
							<?php
						}
					?>      
				</select>
			...
			<div class="form-group">
				...
				<input name="camas" type="text" class="form-control"
                 placeholder="Descrição sobre a(s) cama(s)">
            </div>
			<div class="form-group">
				Preço
				<input name="preco" type="text" class="form-control"
                 placeholder="Preço de unitario dos quartos da catgoria">
            </div>
			<div class="form-group">
				Comodos
				<input name="comodos" type="text" class="form-control"
                 placeholder="Descrição sobre os comodos">
            </div>
			<div class="form-group">
				Descrição
