        ...
        ?>
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						?>
						<tr>
							<td><?php echo $infoUsuario->idCliente; ?></td>
							<td><?php echo $infoUsuario->nome; ?></td>
							<td><?php echo $infoUsuario->cpf; ?></td>
							<td><?php echo $infoUsuario->sexo; ?></td>
							<td><?php echo $infoUsuario->nacionalidade; ?></td>
							<td><?php echo $infoUsuario->transporte; ?></td>
